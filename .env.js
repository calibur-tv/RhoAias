...
const script = {
  ...
  ARMS: `!(function(c,b,d,a){c[a]||(c[a]={});c[a].config={pid:"itlwbq1tcm@3746ad7a990e706",imgUrl:"https://arms-retcode.aliyuncs.com/r.png?",enableSPA:true,useFmp:true};with(b)with(body)with(insertBefore(createElement("script"),firstChild))setAttribute("crossorigin","",src=d)})(window,document,"https://retcode.alicdn.com/retcode/bl.js","__bl");`
};
