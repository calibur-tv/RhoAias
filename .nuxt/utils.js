...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"API_URL":"http://localhost/","API_URL_BROWSER":"https://api.calibur.tv/","SENTRY_URL":"https://63fb1028c6e24cb5be33e8ed64d798e8@sentry.io/1278322","RELEASE":"2019-3-14 07:27:58"}
    }
    // Only set once
