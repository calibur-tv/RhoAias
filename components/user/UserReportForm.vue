...
<template>
  <div id="user-report-form" class="container">
    <VRadio v-model="selectedType" :options="options1" title="违反法律法规" />
    <VRadio v-model="selectedType" :options="options2" title="侵犯个人权益" />
    <VRadio v-model="selectedType" :options="options3" title="有害社区环境" />
