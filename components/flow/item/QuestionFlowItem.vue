...
<template>
  <li class="question-flow-item">
    ...
    <div class="content">
      <nuxt-link v-if="item.answer"
                 :to="$alias.answer(item.answer.id)"
      >
        <div v-if="item.answer.poster"
             class="poster"
        >
          <v-img :src="item.answer.poster.url"
